...
export default function AuthPage({ mode }: { mode: "login" | "register" }) {
  ...
  return <main className="auth-page">
    ...
    <div className="auth-art"><a className="auth-back" href="/"><ArrowLeft size={15} /> Back to studio</a><div className="auth-art-copy"><p className="auth-kicker">TEHILA'S STUDIO / PRIVATE DESK</p><h1>The work<br /><em>continues</em><br />behind the scenes.</h1><p>Manage the shop, upcoming gatherings, portfolio images, journal, and contact enquiries from one quiet place.</p></div><span className="auth-art-caption">A studio is also a record<br />of the things worth making.</span></div>
