...
function AdminDashboardInner() {
  ...
  const isDefaultAdmin = user?.isDefaultAdmin === 1;
  const content = trpc.cms.all.useQuery(undefined, { enabled: isAdmin, retry: false });
  const usersQuery = trpc.users.list.useQuery(undefined, { enabled: isDefaultAdmin, retry: false });
