...
import { ArrowUpRight, CalendarDays, FileText, ImagePlus, Inbox, LayoutDashboard, LogOut, Pencil, Plus, Save, Trash2, Upload, X } from "lucide-react";
...
function AdminDashboardInner() {
  ...
  const section = location === "/admin/events" ? "events" : location === "/admin/images" ? "images" : location === "/admin/canvases" ? "canvases" : location === "/admin/journal" ? "journal" : location === "/admin/enquiries" ? "enquiries" : "overview";
