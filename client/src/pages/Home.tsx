...
export default function Home() {
  ...
  return (
    <main className="studio-app">
      ...
      <footer className="app-footer"><div className="footer-brand"><a className="studio-logo" href="#home"><span className="logo-mark"><CircleDot size={17} /></span><span><b>Threaded Forms</b><small>Tehila's studio</small></span></a><p>Made with thread, patience, and a little joy.</p></div><div className="footer-actions"><a href="https://www.instagram.com/t.ww2.k" target="_blank" rel="noreferrer"><Instagram size={16} /> Instagram</a><a href="mailto:hello@threadedforms.studio">Email <ArrowUpRight size={14} /></a><a href="/contact">Contact <ArrowUpRight size={14} /></a></div><div className="footer-bottom"><span>© {new Date().getFullYear()} Threaded Forms. All rights reserved.</span><a className="growthlab-credit" href="https://www.growthlab.co.ke" target="_blank" rel="noreferrer">Designed by Growthlab <ArrowUpRight size={14} /></a></div></footer>
